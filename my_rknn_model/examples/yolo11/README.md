...
**Video/RTSP/Camera usage (Linux):**

```sh
# Offline video file -> mp4 output
./rknn_yolo11_demo model/yolo11.rknn --input /userdata/test.mp4 --output /userdata/out.mp4 --codec mp4v

# RTSP stream -> mp4 output
./rknn_yolo11_demo model/yolo11.rknn --input rtsp://user:pass@ip/stream --output /userdata/out.mp4 --codec mp4v

# Camera index 0 -> avi output
./rknn_yolo11_demo model/yolo11.rknn --camera 0 --output /userdata/out.avi --codec XVID --fps 30

# Disable drawing for higher FPS
./rknn_yolo11_demo model/yolo11.rknn --input /userdata/test.mp4 --output /userdata/out.mp4 --no-draw

# Disable tracking to reduce postprocess cost
./rknn_yolo11_demo model/yolo11.rknn --input /userdata/test.mp4 --output /userdata/out.mp4 --no-track

# Reduce tracking frequency (update every 2 frames)
./rknn_yolo11_demo model/yolo11.rknn --input /userdata/test.mp4 --output /userdata/out.mp4 --track-interval 2

# Enable RGA preprocessing (opt-in)
./rknn_yolo11_demo model/yolo11.rknn --input /userdata/test.mp4 --output /userdata/out.mp4 --use-rga
```
